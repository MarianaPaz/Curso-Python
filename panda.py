# -*- coding: utf-8 -*-
"""
Created on Fri Jan 24 19:40:57 2020
...
print(len( titulos[titulos.year == 1986] ))
print(titulos[titulos.year == 1986].sort_values('year').head(1))

print(titulos[ titulos.year == 1986].head(1))
...
print(titulos[titulos.year == 2023].sort_values('year'))

len(np.unique(elenco.character))